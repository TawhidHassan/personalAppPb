...
public class TournamentAdapter extends RecyclerView.Adapter<TournamentAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setTournament(int photo, String name, String type, String map, String totalPlayer, String date, String time, String first, String sceound, String third, String perKill, int join)
        {
